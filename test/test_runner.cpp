...
void setup() {
    ...
    RUN_TEST(test_link_rtt_payload_roundtrip);
    RUN_TEST(test_link_control_payloads_are_fernet_tokens);
    RUN_TEST(test_link_forged_proof_is_rejected);
    RUN_TEST(test_espnow_fragment_crc_roundtrip);
    RUN_TEST(test_espnow_store_forward_drops_oldest);
    RUN_TEST(test_identity_persists_and_rejects_corrupt_crc);
    RUN_TEST(test_identity_clone_mac_is_rejected);
    RUN_TEST(test_route_failover_prefers_hops_then_usable_interface);
    RUN_TEST(test_routing_table_holds_many_destinations);
